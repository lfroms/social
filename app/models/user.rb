class User < ApplicationRecord
  ...
  default_url: ->(attachment) { ActionController::Base.helpers.asset_path('nophoto.png') }

  has_attached_file :cover_photo,
  styles: { medium: "700x700>", large: "1500x1500>" },
  default_url: ->(attachment) { ActionController::Base.helpers.asset_path('nocover.jpg') }
